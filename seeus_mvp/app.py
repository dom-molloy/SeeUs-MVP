...
# -------------------- PAGE ROUTING --------------------
# ✅ NEW: Bug Tracker route
if page == "Bug Tracker":
    current_user = st.session_state.get("display_name") or st.session_state.get("user_id") or "unknown"
    render_bug_tracker(current_user)
    st.stop()
